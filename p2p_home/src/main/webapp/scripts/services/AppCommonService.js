var option = {
    'url':{
        'api_user':'http://localhost:8080/user/', //用户相关
        'api_investment':'http://localhost:8080/investment/',
        'api_productRate':'http://localhost:8080/productRate/',
        'api_product':'http://localhost:8080/',
        'api_productAccount':'http://localhost:8080/productaccount/',
        'api_acount':'http://localhost:8080/account/',
        'api_verification':'http://localhost:8080/verification/',
        'api_emailAuth':'http://localhost:8080/emailAuth/',
        'api_paymentpwd':'http://localhost:8080/paymentpwd/',
        'api_extracts':'http://localhost:8080/extracts/',  //提现与支付功能
        'api_bankcardInfo':'http://localhost:8080/bankCardInfo/',
        'api_charges':'http://localhost:8080/charges/'
    },
    'header':{
        'headers':{
        ...
        return {
           ...
           //注册校验验证码的正确性
            ...
            personCenter:function($str){
                ...
                // /itcast_p2p_action/user/accountHomepage
            },
